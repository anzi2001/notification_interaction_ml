...
if __name__ == "__main__":
    files = import_files()
    params = ("device_id", "notification_id",'activity', 'location', 'volume_mode', "locked", 'interaction_time')
    notification_list = filter_device(files, params)
    notification_list = [item[params] for sublist in notification_list for item in sublist]
    #save to csv
    with open("data-old.csv", "w") as f:
        writer = csv.writer(f)
